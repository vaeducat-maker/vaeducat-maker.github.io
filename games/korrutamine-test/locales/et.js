(function(root,factory){
  ...
  return {
    ...
    strings:{
      ...
      'story.worldKicker':'MAAILM ÄRKAB',
      'story.worldArrive':'Saabusime uuele planeedile',
      'story.worldWake':'Esimesed elumärgid',
      'story.worldBloom':'Planeet muutub elavaks',
      'story.worldShine':'Maailm puhkeb õitsele',
      'story.worldComplete':'Elav maailm on valmis!',
      'story.arrival':'Saabumine',
      'story.firstLife':'Esimene elu',
      'story.deepLife':'Ärkav maailm',
      'story.fullWorld':'Täielik õitseng',
