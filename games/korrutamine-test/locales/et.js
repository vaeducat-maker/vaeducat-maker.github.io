(function(root,factory){
  ...
  return {
    ...
    strings:{
      ...
      'intro.loading':'Valmistume stardiks…',
      ...
      'map.total':'Kokku',
      'map.progressAria':'{number}. peatükk: {chapterCompleted}/{chapterTotal}. Kokku {totalCompleted}/{total}.',
      'map.routeAria':'Kosmosetee eesmärgid',
      'map.missionsAria':'Kõigi kuueteistkümne peatüki missioonid',
      'map.multiply':'Korrutamine',
      'map.divide':'Jagamine',
      'map.repeatLesson':'Korda selgitust',
      'map.routeLabel':'KOSMOSETEE · MISSIOONID 1–252',
      ...
      ,'chapter.12.title':'12. PEATÜKK · KORDAMINE','chapter.12.short':'KORDAMINE'
      ,'chapter.13.title':'13. PEATÜKK · KORDAMINE','chapter.13.short':'KORDAMINE'
      ,'chapter.14.title':'14. PEATÜKK · KORDAMINE','chapter.14.short':'KORDAMINE'
      ,'chapter.15.title':'15. PEATÜKK · KORDAMINE','chapter.15.short':'KORDAMINE'
      ,'chapter.16.title':'16. PEATÜKK · KORDAMINE','chapter.16.short':'KORDAMINE'
      ,...Object.fromEntries([
