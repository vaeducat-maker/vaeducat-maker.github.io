(function(root,factory){
  ...
  return {
    ...
    strings:{
      ...
      'story.moon1':'Esimene kuu',
      'story.moon2':'Teine kuu',
      'story.moon3':'Kolmas kuu',
      'story.vault':'Kaardihoidla',
      'story.activateFirstTower':'Käivita esimene kuutorn',
      'story.powerSecondTower':'Anna teisele tornile jõud',
      'story.splitLight':'Jaga valgus kolmeks',
      'story.routeFound':'Uus kosmosetee on avatud!',
      'story.alignMoons':'Joonda kolm kuud',
      'story.openVault':'Ava kaardihoidla',
      'story.mapFragment':'Kaardifragment on leitud!',
      'story.flight':'Lend',
      'story.exploration':'Uurimine',
      'story.return':'Tagasitee',
      'story.upgrade':'Uus jõud',
      'story.flyForward':'Lenda läbi kosmose',
      'story.findSource':'Leia tundmatu energiaallikas',
      'story.bringSource':'Vii leid kosmoselaeva',
      'story.powerRocket':'Anna raketile uus jõud',
      'story.launchReady':'Raketil on uus jõud!',
      ...
      'result.time':'Aeg',
      'story.checkStones':'Kontrolli kive',
      'story.checkStoneAria':'Kontrolli kivi {number}',
      'story.checkAnotherStone':'Kontrolli järgmist kivi',
      'story.checkLastStone':'Kontrolli viimast kivi',
      'story.sourceFound':'See on õige energiakivi!',
      'story.openCase':'Ava kosmosekohver',
      'story.caseReady':'Kivi on turvaliselt kohvris',
      'story.startEngineTap':'Käivita mootor',
      'story.engineAwake':'Mootor sai jõu!',
