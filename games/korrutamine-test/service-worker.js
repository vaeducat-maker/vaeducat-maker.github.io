const CACHE='edukass-korrutustabel-v56-selgitused-fix';
const ASSETS=['./','./index.html','./game.css?v=56','./game.js?v=56-selgitused-fix','./manifest.webmanifest','./locales/et.js?v=56-selgitused-fix','./chapter-one.config.js?v=56','./i18n.js?v=56','./question-engine.js?v=56','./progress-store.js?v=56','./assets/icon-192.png?v=56','./assets/icon-512.png?v=56','./assets/share-korrutustabel.png?v=41','./assets/edukass-cat.png','./assets/edukass-cat-transparent.png','./assets/edukass-cat-reward-surprise.png','./assets/edukass-cat-reward-joy.png','./assets/edukass-kolm-world.png','./assets/edukass-world-rocket.png'];
