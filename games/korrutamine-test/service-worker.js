const CACHE='edukass-korrutustabel-v57-neli-wind-world';
const ASSETS=['./','./index.html','./game.css?v=57','./game.js?v=57','./manifest.webmanifest','./locales/et.js?v=57','./chapter-one.config.js?v=57','./i18n.js?v=57','./question-engine.js?v=57','./progress-store.js?v=57','./assets/icon-192.png?v=57','./assets/icon-512.png?v=57','./assets/share-korrutustabel.png?v=41','./assets/edukass-cat.png','./assets/edukass-cat-transparent.png','./assets/edukass-cat-reward-surprise.png','./assets/edukass-cat-reward-joy.png','./assets/edukass-kolm-world.png','./assets/edukass-world-rocket.png'];
