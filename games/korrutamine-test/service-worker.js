const CACHE='edukass-korrutustabel-v90-safe-install';
const ASSETS=['./','./index.html','./game.css?v=90','./game.js?v=90','./manifest.webmanifest','./locales/et.js?v=90','./chapter-one.config.js?v=90','./i18n.js?v=61','./question-engine.js?v=61','./progress-store.js?v=90','./assets/icon-192.png?v=61','./assets/icon-512.png?v=61','./assets/share-korrutustabel.png?v=41','./assets/edukass-cat.png','./assets/edukass-cat-transparent.png','./assets/edukass-cat-reward-surprise.png','./assets/edukass-cat-reward-joy.png','./assets/edukass-kolm-world.png','./assets/edukass-world-rocket.png'];
