const CACHE='edukass-korrutustabel-v59-neli-alien-settlement';
const ASSETS=['./','./index.html','./game.css?v=59','./game.js?v=59','./manifest.webmanifest','./locales/et.js?v=59','./chapter-one.config.js?v=59','./i18n.js?v=59','./question-engine.js?v=59','./progress-store.js?v=59','./assets/icon-192.png?v=59','./assets/icon-512.png?v=59','./assets/share-korrutustabel.png?v=41','./assets/edukass-cat.png','./assets/edukass-cat-transparent.png','./assets/edukass-cat-reward-surprise.png','./assets/edukass-cat-reward-joy.png','./assets/edukass-kolm-world.png','./assets/edukass-world-rocket.png'];
