const CACHE='edukass-korrutustabel-v58-neli-world-readability-map-fix';
const ASSETS=['./','./index.html','./game.css?v=58','./game.js?v=58','./manifest.webmanifest','./locales/et.js?v=58','./chapter-one.config.js?v=58','./i18n.js?v=58','./question-engine.js?v=58','./progress-store.js?v=58','./assets/icon-192.png?v=58','./assets/icon-512.png?v=58','./assets/share-korrutustabel.png?v=41','./assets/edukass-cat.png','./assets/edukass-cat-transparent.png','./assets/edukass-cat-reward-surprise.png','./assets/edukass-cat-reward-joy.png','./assets/edukass-kolm-world.png','./assets/edukass-world-rocket.png'];
