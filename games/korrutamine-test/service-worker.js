const CACHE='edukass-korrutustabel-v68-alien-hanging-gardens';
const ASSETS=['./','./index.html','./game.css?v=68','./game.js?v=68','./manifest.webmanifest','./locales/et.js?v=68','./chapter-one.config.js?v=68','./i18n.js?v=61','./question-engine.js?v=61','./progress-store.js?v=61','./assets/icon-192.png?v=61','./assets/icon-512.png?v=61','./assets/share-korrutustabel.png?v=41','./assets/edukass-cat.png','./assets/edukass-cat-transparent.png','./assets/edukass-cat-reward-surprise.png','./assets/edukass-cat-reward-joy.png','./assets/edukass-kolm-world.png','./assets/edukass-world-rocket.png'];
